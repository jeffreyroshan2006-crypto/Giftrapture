...
const categories = [
  {
    ...
    href: "/shop/bouquets",
    className: "col-span-12 md:col-span-6 lg:col-span-5 h-[350px] md:h-[500px]",
  },
  {
    ...
    href: "/shop/hampers",
    className: "col-span-12 md:col-span-6 lg:col-span-7 h-[350px] md:h-[500px]",
  },
  {
    title: "Wedding Trousseau",
    tagline: "Bridal Dreams",
    image: "/images/cat-wedding.png",
    href: "/services/trousseau",
    className: "col-span-12 md:col-span-7 h-[350px] md:h-[400px]",
  },
  {
    ...
    href: "/shop/occasions",
    className: "col-span-12 md:col-span-5 h-[350px] md:h-[400px]",
  },
  {
    ...
    className: "col-span-12 h-[350px] md:h-[400px]",
  },
];
