              ...
              <div className="bg-white p-8 rounded-3xl shadow-sm border border-text-main/5 sticky top-32">
                ...
                <div className="mb-6">
                  ...
                  <button
                    ...
                    className="w-full py-4 bg-gradient-to-r from-[#075e54] to-[#25d366] text-white font-bold rounded-full transition-all duration-300 shadow-lg hover:shadow-[0_8px_25px_rgba(37,211,102,0.4)] hover:scale-[1.02] flex items-center justify-center gap-2.5 disabled:opacity-60 disabled:cursor-not-allowed group"
                  >
